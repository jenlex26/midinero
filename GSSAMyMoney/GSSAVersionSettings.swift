...
public struct myMoneyFrameworkSettings{
    ...
    var checkuserActivations   : Bool = false //Shows physical debit card flow (request, activate, turn on/off) in settings screen, even if firebase flag is set on false.dfsdfs 
